...
from dataloaders.datasets import DataSet_Dermnet_Teacher_or_Stu, DataSet_Dermnet_MT_SSL, TwoStreamBatchSampler
...
parser.add_argument('--root_path', type=str,
                    default='/mnt/ssd2/guest/baiye/Super-Stu/data/DermnetData', help='the ROOT path/the path of dataset')
...
parser.add_argument('--t_model_path', type=str,
                    default='XXXXXXXXXXXX.pth', help='teacher_model_path')
parser.add_argument('--s_model', type=str,
                    default='ShiftMLP_b', help='student_model_name')
...
parser.add_argument('--seed', type=int, default=57366, help='random seed')
...
def train(args, snapshot_path):
    ...
    db_train = DataSet_Dermnet_MT_SSL(base_dir=args.root_path, split="train", num=None,
                                   transform=transforms.Dermnet_Train_Transforms)
    db_val = DataSet_Dermnet_MT_SSL(base_dir=args.root_path, split="val", transform=transforms.Dermnet_Val_Transforms)
    ...
    for epoch_num in iterator:
        ...
        for i_batch, (img, label) in enumerate(trainloader):
            ...
            loss = supervised_loss * (1 - args.alpha) + consistency_weight * consistency_loss + KD_loss * (args.alpha)
        ...
        with torch.no_grad():
            ...
            if val_epoch_acc > best_performance:
                ...
                save_best = os.path.join(snapshot_path,
                                         '{}_best_model.pth'.format(args.s_model))
    ...
    writer.close()
    plots.plot_loss_and_acc(train_loss_to_plot, val_loss_to_plot, train_acc_to_plot, val_acc_to_plot, "MTKD_Dermnet")
...
if __name__ == "__main__":
    ...
    snapshot_path = "/mnt/ssd2/guest/baiye/Super-Stu/model/{}/{}".format(args.exp, args.s_model)
