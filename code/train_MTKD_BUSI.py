...
from dataloaders.datasets import DataSet_BUSI_Teacher_or_Stu, DataSet_BUSI_MT_SSL, TwoStreamBatchSampler
...
parser.add_argument('--root_path', type=str,
                    default='/mnt/ssd2/guest/baiye/Super-Stu/data/Breast', help='the ROOT path/the path of dataset')
parser.add_argument('--exp', type=str,
                    default='Breast/MTKD', help='experiment_name')
parser.add_argument('--t_model', type=str,
                    default='UASwinTv2t', help='teacher_model_name')
parser.add_argument('--t_model_path', type=str,
                    default='XXXXXXXXXXX.pth', help='teacher_model_path')
...
def train(args, snapshot_path):
    ...
    db_train = DataSet_BUSI_MT_SSL(base_dir=args.root_path, split="train", num=None,
                                   transform=transforms.BUSI_Train_Transforms)
    db_val = DataSet_BUSI_MT_SSL(base_dir=args.root_path, split="val", transform=transforms.BUSI_Val_Transforms)
    ...
    optimizer = optim.SGD(student_model.parameters(), lr=base_lr, momentum=0.9, weight_decay=0.00001)
    ...
    writer.close()
    plots.plot_loss_and_acc(train_loss_to_plot, val_loss_to_plot, train_acc_to_plot, val_acc_to_plot, "MTKD_BUSI")
