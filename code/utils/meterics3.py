...
N_CLASSES = 5
CLASS_NAMES = ['Acne and Rosacea Photos', 'Melanoma Skin Cancer Nevi and Moles', 'Vascular Tumors', 'Hair Loss Photos Alopecia and other Hair Diseases', 'Eczema Photos']
