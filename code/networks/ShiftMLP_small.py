...
class ShiftMLP_s(nn.Module):
    ...
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
        ...
        self.sum_conv = nn.Conv2d(224, 64, kernel_size=1)
    ...
    def forward(self, x):
        ...
        out_sum = torch.cat([out_t1, out_t2, out_t3], 1)
...
if __name__ == '__main__':
    ...
    model = ShiftMLP_s(in_chans=3, num_classes=7, img_size=224)
    # 计算参数量
