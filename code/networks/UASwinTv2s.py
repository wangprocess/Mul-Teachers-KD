...
class UASwinV2S(nn.Module):
    def __init__(self, in_chns, num_classes, image_size):
        super(UASwinV2S, self).__init__()
        ...
        self.swin_v2 = models.swin_v2_s(weights=Swin_V2_S_Weights.IMAGENET1K_V1)
...
if __name__ == '__main__':
    ...
    # Initialize model
    model = UASwinV2S(channels, num_classes, img_size).cuda()
    # print(model)
