...
class UASwinV2T(nn.Module):
    def __init__(self, in_chns, num_classes, image_size):
        super(UASwinV2T, self).__init__()
        ...
        self.swin_v2 = models.swin_v2_t(weights=Swin_V2_T_Weights.IMAGENET1K_V1)
...
if __name__ == '__main__':
    ...
    # Initialize model
    model = UASwinV2T(channels, num_classes, img_size).cuda()
    # print(model)
